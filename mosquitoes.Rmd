...
The "activated" scores for the beer subjects:

```{python}
# The 'activated' numbers for the after beer rows.
beer_activated = np.array([14, 33, 27, 11, 12, 27, 26, 25, 27, 27, 22, 36, 37,
                           3, 23,  7, 25, 17, 36, 31, 30, 22, 20, 29, 23])
beer_activated
```
...
water_activated = np.array([33, 23, 23, 13, 24,  8,  4, 21, 24, 21, 26, 27, 22,
                            21, 25, 20,  7, 3])
water_activated
```
